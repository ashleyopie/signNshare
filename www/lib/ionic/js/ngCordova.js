...
(function() {
    ...
    .factory('$cordovaBarcodeScanner', ['$q',
        function($q) {
    ...
    .factory('$cordovaDeviceOrientation', ['$q',
        function($q) {
        ...
        function($q) {
            ...
            return {
                ...
                checkFile: function(dir, file) {
                    ...
                    getFilesystem().then(
                        function(filesystem) {
                            filesystem.root.getFile('/' + dir + '/' + file, {
                                    create: false
                                },
                                // File exists
                                function() {
    ...
    .factory('$cordovaGlobalization', ['$q',
        function($q) {
    ...
    .factory('$cordovaSocialSharing', ['$q',
        function($q) {
